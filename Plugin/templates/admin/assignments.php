...
<?php
// Scripts are now properly enqueued via class-mt-assignments-page.php using admin_enqueue_scripts hook
// This follows WordPress best practices for script loading
?>

<!-- Action-specific nonces for security -->
<input type="hidden" id="mt_auto_assign_nonce" value="<?php echo wp_create_nonce('mt_auto_assign_action'); ?>" />
<input type="hidden" id="mt_manual_assign_nonce" value="<?php echo wp_create_nonce('mt_manual_assign_action'); ?>" />
<input type="hidden" id="mt_remove_assignment_nonce" value="<?php echo wp_create_nonce('mt_remove_assignment_action'); ?>" />
<input type="hidden" id="mt_clear_assignments_nonce" value="<?php echo wp_create_nonce('mt_clear_assignments_action'); ?>" />
<input type="hidden" id="mt_admin_nonce" value="<?php echo wp_create_nonce('mt_admin_nonce'); ?>" />
